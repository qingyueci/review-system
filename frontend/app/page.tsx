...
export default function Home() {
  ...
  const [currentDate, setCurrentDate] = useState(todayText);
          ...
          <div className="context-bar">
            ...
            {activeNav === "今日复盘" && (
              <div className="context-tools">
                <input className="date-input" type="date" value={reviewDate} max={currentDate} onChange={(event) => setReviewDate(event.target.value)} aria-label="复盘日期" />
